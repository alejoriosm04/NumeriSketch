...
def bisection_graph(fun, xi, xs, root=None, png_path='static/graphs/bisection_graph.png', svg_path='static/graphs/bisection_graph.svg'):
...
def bisection_method(Xi, Xs, Tol, Niter, Fun, safe_dict):
    fm = []
    E = []
    x = Xi
